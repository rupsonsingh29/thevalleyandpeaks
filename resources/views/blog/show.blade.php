...
@push('meta')
    ...
    <meta property="article:modified_time" content="{{ ($article->content_updated_at ?? $article->updated_at)->toIso8601String() }}">
...
<article itemscope itemtype="https://schema.org/Article">
    ...
    <div class="container" style="margin-bottom: 2rem;">
        <div class="article-featured-image">
            @if($article->featured_image)
                <img src="{{ asset('storage/'.$article->featured_image) }}" alt="{{ $article->title }}" itemprop="image" style="width:100%;height:100%;object-fit:cover;">
            @else
                <div class="card__image--placeholder" style="height:100%;font-size:2rem;">{{ $article->category->name }}</div>
            @endif
        </div>
    </div>
        ...
        <div class="article-layout">
            ...
            <div>
                ...
                <div class="article-tags">
                    <strong style="font-size: 0.8125rem; color: var(--color-muted); margin-right: 0.5rem;">Destinations:</strong>
